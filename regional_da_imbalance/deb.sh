...
#source $modulefile
#:wq MPIIFORT=/apps/intel/compilers_and_libraries_2018/linux/mpi/intel64/bin/mpiifort
...
mpiifort -o  prep_for_regional_DA.x  -I${NETCDF_INCLUDES} -g -debug   prep_for_regional_DA.F90   -L${NETCDF_LIBRARIES} -lnetcdff -lnetcdf #-I${HDF5INCLUDE} -L${HDF5LIB} -lhdf5_hl -lhdf5 -lm -lz
