...
moduledir=/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-GFSV16-regional-workflow/regional_workflow/modulefiles/hera
...
ifort -g -traceback -fp-model precise -xAVX $NETCDF_INCLUDE $NETCDF_LDFLAGS prep_for_regional_DA.F90
...
ifort -g -traceback -fp-model precise -xAVX $NETCDF_INCLUDE $NETCDF_LDFLAGS create_expanded_restart_files_for_DA.F90
