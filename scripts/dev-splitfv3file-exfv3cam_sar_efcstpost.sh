...
if [ $ldo_enscalc_option -ne 2  ] ; then
   ...
   ensmeanchar="ensmean"  #cltthinkto
            cp   $EnsMeanDir/${PDY}.${CYC}0000.${ensfiletype:-bg}_ensmean_fv_dynvars fv3sar_tile1_${ensmeanchar}_dynvars
            cp   $EnsMeanDir/${PDY}.${CYC}0000.${ensfiletype:-bg}_ensmean_fv_tracer fv3sar_tile1_${ensmeanchar}_tracer  
...
#cltthinkdeb	startmsg
    ENKFEXEC=/scratch2/NCEPDEV/fv3-cam/Ting.Lei/dr-github-gsi-master/GSI/build/bin/enkf_fv3reg_DBG.x
