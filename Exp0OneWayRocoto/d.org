...
<!ENTITY EXPenvir "EXP0OneWayregion">
...
<!ENTITY l_use_other_ctrlb_opt '.true.'>
<!ENTITY envirlbctm00 'EXP0Gensregion'>
<!ENTITY envir_ctrl 'EXP0Gensregion'>
<!ENTITY l_use_own_glb_ensemble '.true.'>
...
<!--  ********** Run the tm06 analysis **************************************  -->
  ...
  <task name="analysis_tm06" cycledefs="regional" maxtries="6">
    ...
    <envar>
      <name>envir_ctrl</name>
      <value>&envir_ctrl;</value>
    </envar>
   <envar>
...
<!--  ********************** Run the post processor *********************  -->
  ...
  <metatask name="post_tm00">
    ...
    &RESERVATION;
    &POST_RESOURCES;
      <command>&PRE; &JOBS;/JFV3CAM_SAR_POST</command>
