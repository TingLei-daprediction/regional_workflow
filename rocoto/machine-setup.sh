...
#clt    module purge > /dev/null 2>&1
#clt    module use /usrx/local/prod/modulefiles
#clt    module use /gpfs/hps/nco/ops/nwprod/lib/modulefiles
#clt    module use /gpfs/hps/nco/ops/nwprod/modulefiles
#clt    module use /opt/cray/alt-modulefiles
#clt    module use /opt/cray/craype/default/alt-modulefiles
#clt    module use /opt/cray/ari/modulefiles
#clt    module use /opt/modulefiles
    module purge > /dev/null 2>&1

    # Workaround until module issues are fixed:
#clt    unset _LMFILES_
#clt    unset LOADEDMODULES
#clt    echo y 2> /dev/null | module clear > /dev/null 2>&1
...
#clt    module use /opt/cray/alt-modulefiles
#clt    module use /opt/cray/craype/default/alt-modulefiles
#lt    module use /opt/cray/ari/modulefiles
#clt    module use /opt/modulefiles
#clt   module load modules
