...
<!ENTITY EXPenvir "EXP0Gensregion">
...
<!ENTITY CHGRES_IC_RESOURCES_tm00 "<nodes>4:ppn=3</nodes><envar><name>TOTAL_TASKS</name><value>12</value></envar><envar><name>NCTSK</name><value>3</value></envar><envar><name>OMP_THREADS</name><value>1</value></envar><walltime>03:30:00</walltime>">
...
<!ENTITY ENKF_EXTRA "<envar><name>NCTSK</name><value>2</value></envar><envar><name>OMP_THREADS</name><value>1</value></envar><walltime>01:30:00</walltime>">
...
<!--  ********** Run the tm06 analysis **************************************  -->
  ...
  <task name="analysis_tm06" cycledefs="regional" maxtries="6">
    ...
    <envar>
      <name>l_twoway_hybrid_opt</name>
      <value>&l_twoway_hybrid_opt;</value>
    </envar>
    <envar>
  ...
  <cores>1</cores>
    ...
    <dependency>
       ...
       <metataskdep metatask="post_tm00"/>
        <datadep age="00:00:05:00"><cyclestr>&DATAROOT;/xxthinkdebforecast_tm00_@H_@Y@m@d/logf0#fhr#</cyclestr></datadep>
       </and>
    </dependency>
  </task>
