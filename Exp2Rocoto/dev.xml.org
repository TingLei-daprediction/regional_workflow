...
<!ENTITY HOMEfv3 "/gpfs/dell2/emc/modeling/noscrub/&USER;/dr-regional-workflow/regional_workflow">
<!ENTITY JOBS "&HOMEfv3;/jobs">
<!ENTITY SCRIPTS "&HOMEfv3;/scripts">
<!ENTITY COMgfs "/gpfs/dell1/nco/ops/com/gfs/para">
<!ENTITY OUTDIR "/gpfs/dell2/ptmp/&USER;/&EXPenvir;">
<!ENTITY DATAROOT "/gpfs/dell2/ptmp/&USER;/tmpnwprd_hourly/&EXPenvir;">
...
<!ENTITY SCRUB_RESOURCES '<walltime>00:10:00</walltime><memory>1G</memory><native>-R affinity[core]</native>'>
...
<!ENTITY CHGRES_ENS_IC_RESOURCES '<walltime>02:30:00</walltime><native>-R affinity[core]</native>'>
<!ENTITY CHGRES_BC_RESOURCES '<walltime>00:20:00</walltime><native>-R affinity[core]</native>'>
<!ENTITY CHGRES_ENS_BC_RESOURCES '<walltime>02:20:00</walltime><native>-R affinity[core]</native>'>
<!ENTITY FCST_RESOURCES_GUESS '<walltime>01:00:00</walltime><native>-R affinity[core\(2\):distribute=balance]</native>'>
<!ENTITY FCST_RESOURCES_DA '<walltime>00:10:00</walltime><native>-R affinity[core\(2\):distribute=balance]</native>'>
<!ENTITY FCST_RESOURCES '<walltime>01:35:00</walltime><native>-R affinity[core\(2\):distribute=balance]</native>'>
<!ENTITY POST_RESOURCES '<walltime>00:20:00</walltime><native>-R affinity[core]</native>'>
<!ENTITY ANL_RESOURCES '<walltime>02:30:00</walltime><native>-R affinity[core]</native>'>
...
<!ENTITY ENKFEXEC '/gpfs/dell2/emc/modeling/noscrub/Ting.Lei/dr-CAM/dr-enkf_fv3native_t2/ProdGSI/build/bin/enkf_fv3reg.x'>
<!ENTITY gsiexec ' /gpfs/dell2/emc/modeling/noscrub/Ting.Lei/dr-CAM/dr-EXP-GSI_fv3_reg_ensemble_dualv1mix1/ProdGSI/build/bin/gsi.x'>
<!ENTITY gsianlsh ''> 
<!ENTITY nens '4'> 
<!ENTITY l_both_fv3sar_gfs_ens '.true.'> 
<!ENTITY nens_gfs '2'> 
<!ENTITY nens_fv3sar '2'> 
...
<workflow realtime="T" scheduler="lsf" taskthrottle="60" cyclethrottle="2" cyclelifespan="23:18:00:00">
...
<!-- Create the initial conditions at tm12 and boundary condition from tm12-tm06 from the FV3GFS -->
 ...
 <metatask name="chgres_ens_firstguess">
  ...
  <cores>1</cores>
    <command>&JOBS;/launch.ksh  &JOBS;/dev-JFV3CAM_SAR_CHGRES_ENS_FIRSTGUESS</command>
    <jobname><cyclestr>chgres_ens#ENSGRP#_guess_@H_tm12</cyclestr></jobname>
    <join><cyclestr>&OUTDIR;/testlogs_hourly_rocoto/chgres_ens#ENSGRP#_@H_firstguess.log</cyclestr></join>
    <envar>
      <name>envir</name>
      <value>&EXPenvir;</value>
    </envar>
...
<!--  ********** Run the 6-h forecast from tm12 to tm06 *********************  -->
  ...
  <nodes>54:ppn=12</nodes>
    <command>&JOBS;/launch.ksh &JOBS;/dev-JFV3CAM_SAR_FCST</command>
 ...
 <metatask name="forecast_ens_firstguess">
  ...
  &FCST_RESOURCES_GUESS;
  <nodes>54:ppn=12</nodes>
    <command>&JOBS;/launch.ksh &JOBS;/dev-JFV3CAM_SAR_ENKF_FCST</command>
    <jobname><cyclestr>forecast_ens#ENSGRP#_firstguess_@H</cyclestr></jobname>
    <join><cyclestr>&OUTDIR;/testlogs_hourly_rocoto/forecast_ens#ENSGRP#_firstguess_@H.log</cyclestr></join>
    <envar>
      <name>envir</name>
      <value>&EXPenvir;</value>
    </envar>
...
<!-- Create the boundary conditions from tm06-tm01 -->
  ...
  <metatask name="chgres_ens_fcstbndy_da_ensgrp#ENSGRP#">
    ...
    &RESERVATION;
    &CHGRES_ENS_BC_RESOURCES;
    <nodes>1:ppn=24</nodes>
    <command>&JOBS;/launch.ksh &JOBS;/dev-JFV3CAM_SAR_CHGRES_ENS_FCSTBNDY</command>
    <jobname><cyclestr>chgres_ens#ENSGRP#_fcstbndy_tm#mark#_@H</cyclestr></jobname>
    <join><cyclestr>&OUTDIR;/testlogs_hourly_rocoto/chgres_ens#ENSGRP#_fcstbndy_tm#mark#_@H.log</cyclestr></join>
    <envar>
      <name>envir</name>
      <value>&EXPenvir;</value>
    </envar>
...
<!--  ********** Run the tm06 analysis **************************************  -->
  ...
  <nodes>10:ppn=24</nodes>
    <command>&JOBS;/launch.ksh &JOBS;/dev-JFV3CAM_SAR_GSIANL</command>
  ...
  &RESERVATION;
  &ANL_RESOURCES;
  <nodes>40:ppn=6</nodes>
    <command>&JOBS;/launch.ksh &JOBS;/dev-FV3CAM_SAR_EFCSTPOST</command>
    <jobname><cyclestr>epost2mean_tm06_@H</cyclestr></jobname>
    <join><cyclestr>&OUTDIR;/testlogs_hourly_rocoto/deb-epost2mean_tm06_@H.log</cyclestr></join>
    <envar>
      <name>envir</name>
      <value>&EXPenvir;</value>
    </envar>
  ...
  &ANL_RESOURCES;
  <nodes>10:ppn=24</nodes>
    <command>&JOBS;/launch.ksh &JOBS;/JFVCAM_SAR_ENKF_ENSMEAN_OBS</command>
    <jobname><cyclestr>emean_obs_tm06_@H</cyclestr></jobname>
    <join><cyclestr>&OUTDIR;/testlogs_hourly_rocoto/emean_obs_tm06_@H.log</cyclestr></join>
    <envar>
      <name>envir</name>
      <value>&EXPenvir;</value>
    </envar>
  ...
  &ANL_RESOURCES;
  <nodes>10:ppn=24</nodes>
    <command>&JOBS;/launch.ksh &JOBS;/JFVCAM_SAR_ENKF_OBS</command>
    <jobname><cyclestr>enkf_obs_tm06_@H</cyclestr></jobname>
    <join><cyclestr>&OUTDIR;/testlogs_hourly_rocoto/enkf_obs_tm06_grp#ENSGRP#_@H.log</cyclestr></join>
    <envar>
      <name>envir</name>
      <value>&EXPenvir;</value>
    </envar>
  ...
  <nodes>40:ppn=6</nodes>
    ...
    <join><cyclestr>&OUTDIR;/testlogs_hourly_rocoto/enkf_eupd_tm06_@H.log</cyclestr></join>
    <envar>
      <name>envir</name>
      <value>&EXPenvir;</value>
    </envar>
  ...
  <nodes>40:ppn=6</nodes>
    ...
    <join><cyclestr>&OUTDIR;/testlogs_hourly_rocoto/recenter_tm06_@H.log</cyclestr></join>
    <envar>
      <name>envir</name>
      <value>&EXPenvir;</value>
    </envar>
...
<!--  ***********************************************************************  -->
  ...
  <nodes>54:ppn=12</nodes>
    ...
    <join><cyclestr>&OUTDIR;/testlogs_hourly_rocoto/forecast_ens#ENSGRP#_tm#mark#_@H.log</cyclestr></join>
    <envar>
      <name>envir</name>
      <value>&EXPenvir;</value>
    </envar>
...
<metatask name="EnKF_analysis_tm#next_mark#">
  ...
  <nodes>40:ppn=6</nodes>
    ...
    <join><cyclestr>&OUTDIR;/testlogs_hourly_rocoto/epost2mean_tm#next_mark#_@H.log</cyclestr></join>
     <envar>
      <name>ldo_enscalc_option</name>
      <value>1</value>
    </envar>
  ...
  <nodes>10:ppn=24</nodes>
    ...
    <join><cyclestr>&OUTDIR;/testlogs_hourly_rocoto/emean_obs_tm#next_mark#_@H.log</cyclestr></join>
    <envar>
      <name>envir</name>
      <value>&EXPenvir;</value>
    </envar>
  ...
  <nodes>10:ppn=24</nodes>
    ...
    <join><cyclestr>&OUTDIR;/testlogs_hourly_rocoto/enkf_obs_tm#next_mark#_grp#ENSGRP#_@H.log</cyclestr></join>
    <envar>
      <name>envir</name>
      <value>&EXPenvir;</value>
    </envar>
  ...
  <nodes>40:ppn=6</nodes>
    ...
    <join><cyclestr>&OUTDIR;/testlogs_hourly_rocoto/eenkf_eupd_tm#next_mark#_@H.log</cyclestr></join>
    <envar>
      <name>envir</name>
      <value>&EXPenvir;</value>
    </envar>
  ...
  <nodes>40:ppn=6</nodes>
    ...
    <join><cyclestr>&OUTDIR;/testlogs_hourly_rocoto/recenter_tm#next_mark#_@H.log</cyclestr></join>
    <envar>
      <name>envir</name>
      <value>&EXPenvir;</value>
    </envar>
...
<!-- Create the boundary conditions for the 60-h forecast -->
  ...
  <nodes>21:ppn=1</nodes>
    ...
    <join><cyclestr>&OUTDIR;/testlogs_hourly_rocoto/chgres_fcstbndy.tm00_@H.log</cyclestr></join>
    <envar>
      <name>envir</name>
      <value>&EXPenvir;</value>
    </envar>
